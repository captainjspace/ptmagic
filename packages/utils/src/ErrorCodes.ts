...
export const CalcTokenErrorCode: Partial< Record<SeverityKey, Record<SubjectKey, string>> > = {
  [SeverityKeys.exits]: {
    ...
    [SubjectKeys.TOKEN_RESERVE]: "Token Reserves are drained.  Active Open Requests: %s Current Burn: %s",
  },
};
...
export const getErrorCode = (
  ...
  return severityErrors?.[subject]?? "Unknown Error Code";
};
