...
const initialConfig = {
  ...
  site: { dailyUsers: 250000, canary: 0.05, rush: 0.20 }
};
...
export default function DataDisplay() {
  ...
  const handleInputChange = (key: string, val: any) => {
    setConfig(prev => {
      ...
      if (key === 'contextHistoryTokens') updated.inputTokens.contextHistory.tokens = val;
      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {Object.entries(data).map(([sectionName, fields]) => {
            ...
            if (sectionName === "timeFactors" || sectionName === "modelCalc") return null;
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    {Object.entries(fields as Record<string, any>).map(([key, value]) => {
                      ...
                      const isConfigurable = ['promptTokens', 'contextHistoryTokens', 'contextFactor', 'turnsPerMinute', 'isCached'].includes(key);
