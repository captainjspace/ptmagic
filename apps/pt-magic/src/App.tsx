      ...
      <div className="max-w-7xl mx-auto">
        <header className="mb-10 flex flex-col md:flex-row md:items-end justify-between gap-4 border-b border-slate-800/60 pb-8 text-center md:text-left">
          <div>
            ...
            <p className="text-slate-500 font-semibold uppercase tracking-widest text-[10px]">Provisioned Throughput & Burst Bucket Dynamics</p>
          </div>
        ...
        <main className="mt-8">
          {activeTab === 0 && <DataDisplay data={data} onInputChange={handleInputChange} />}
